...
import org.springframework.beans.factory.annotation.Value; 
 ...
 import org.apache.kafka.clients.producer.ProducerRecord;
  ...
  @SpringBootApplication public class IntegrationApplication implements CommandLineRunner {
	  ...
	  @Value("${kafka.topic.TestTopic}")
	    ...
	    //private static final Logger logger = Logger.getLogger(IntegrationApplication.class);
...
public void run(String... args) throws Exception {
    ...
    Thread kafkaConsumerThread = new Thread(() -> {
        ...
        KafkaConsumerEx simpleKafkaConsumer = new KafkaConsumerEx(
